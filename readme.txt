...
Tags: talk to customers, talk to visitors, chat with customers, chat with visitors, live chat software,Êlive help software,Êlive support,Êplugin,Êtrouble ticket, widget, ticket system, help desk software, help desk, callback, email management, customer service, customer service software
...
== Installation ==
1. Activate `LiveHelpNow Help Desk -- Chat Button` through the 'Plugins' menu in WordPress.
...
4. Add Widget to a Wordpress section.
5. Fill out widget form.

== Changelog ==
**2.0** - 2013/03/22

* Updated code base for improved performance
* Allows for multiple chat button to be placed on webpage
* Send user information back to your LiveHelpNow operators
...
== Upgrade Notice ==
= 2.0 =
This update has an updated code base for improved performance. The update allows allows for multiple chat buttons to be placed on webpages and sends user information back to your LiveHelpNow operators.

== Screenshots ==
1. LiveHelpNow's available chat buttons and button ID numbers.
